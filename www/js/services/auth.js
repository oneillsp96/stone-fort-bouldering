angular.module('App').factory('Auth', function (FURL, $firebaseAuth, $firebaseArray, $firebaseObject, Utils, Problems) {
  ...
  var Auth = {
    ...
    createProfile: function (uid, user) {
      ...
      var profileRef = $firebaseArray(ref.child('stoneFortUsers'));
  ...
  auth.$onAuth(function (authData) {
    if (authData) {
      ...
      Auth.user.profile = $firebaseObject(ref.child('stoneFortUsers').child(authData.uid));
